...
/**
 * Creates the auth router using the validated frontend URL from application config.
 * Accepts the frontend origin as a parameter rather than reading process.env directly,
 * ensuring the URL has been validated before use in redirect targets.
 *
